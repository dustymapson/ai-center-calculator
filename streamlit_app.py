...
def create_combined_pdf():
    ...
    title_style = ParagraphStyle(
        ...
        textColor=GOLD, spaceAfter=8, leading=22
    )
    subtitle_style = ParagraphStyle(
        'Sub', fontName='Helvetica-Bold', fontSize=8,
        textColor=WHITE, spaceAfter=14, spaceBefore=2
    )
    ...
    label_style = ParagraphStyle(
        'Lab', fontName='Helvetica-Bold', fontSize=9,
        textColor=WHITE, alignment=TA_CENTER, spaceAfter=6
    )
    big_style = ParagraphStyle(
        'Big', fontName='Helvetica-Bold', fontSize=26,
        textColor=GOLD, alignment=TA_CENTER, spaceBefore=8, spaceAfter=8, leading=30
    )
    sub_label_style = ParagraphStyle(
        'SubLab', fontName='Helvetica-Bold', fontSize=8,
        textColor=WHITE, alignment=TA_CENTER, spaceBefore=4, spaceAfter=12
    )
    footer_style = ParagraphStyle(
        'Foot', fontName='Helvetica-Bold', fontSize=7,
    ...
    for price_point, label in [(49, "$49 / PATIENT"), (39, "$39 / PATIENT"), (29, "$29 / PATIENT")]:
        ...
        for i, row in enumerate(rows):
            if "Conservative" in str(row[0]) or "Standard" in str(row[0]) or "Best Case" in str(
